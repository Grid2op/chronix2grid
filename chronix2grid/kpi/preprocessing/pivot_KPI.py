...
from kpi.preprocessing.pivot_utils import chronics_to_kpi, eco2mix_to_kpi

def pivot_format(chronics_folder, kpi_input_folder, year, scenario_num, prods_charac, loads_charac, wind_solar_only):
    ...
    syn_prod, syn_load = chronics_to_kpi(year, scenario_num, chronics_folder, timestep, thermal = not wind_solar_only)
