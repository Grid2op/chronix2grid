...
class EconomicDispatchValidator:
    ...
    def __init__(self, ref_consumption, syn_consumption, ref_dispatch, synthetic_dispatch, year, num_scenario,
        ...
        if syn_prices is not None and ref_prices is not None:
            ...
            print("Warning: prices data have not been given for both synthetic and reference dispatch. \n"
                  ...
                  "Next time, you can provide kpi/input/France/eco2mix/price_"+str(year)+".csv \n")
    ...
    def thermal_load_kpi(self, save_plots = True):
        ...
        corr(thermal, load) Region R1 (pd.DataFrame)
        corr(thermal, load) Region R2 (pd.DataFrame)
        corr(thermal, load) Region R3 (pd.DataFrame)
        '''
